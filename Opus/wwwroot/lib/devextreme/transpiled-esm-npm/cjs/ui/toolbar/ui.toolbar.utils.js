...
function toggleItemFocusableElementTabIndex(context, item) {
  ...
  if (widget && TOOLBAR_ITEMS.indexOf(widget) !== -1) {
    ...
    if ($widget.length) {
      ...
      var $focusTarget = widget === 'dxDropDownButton' ? itemInstance._focusTarget().find(".".concat(BUTTON_GROUP_CLASS)) : (itemInstance === null || itemInstance === void 0 ? void 0 : (_itemInstance$_focusT = itemInstance._focusTarget) === null || _itemInstance$_focusT === void 0 ? void 0 : _itemInstance$_focusT.call(itemInstance)) || (0, _renderer.default)(itemInstance.element());
