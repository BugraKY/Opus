...
class SchedulerWorkSpace extends WidgetObserver {
  ...
  _createCrossScrollingConfig(currentConfig) {
    ...
    config.onScroll = e => {
      ...
      if (this._sideBarSemaphore.isFree(e.scrollOffset)) {
        ...
        (_this$_sidebarScrolla = this._sidebarScrollable) === null || _this$_sidebarScrolla === void 0 ? void 0 : _this$_sidebarScrolla.scrollTo({
      ...
      if (this._headerSemaphore.isFree(e.scrollOffset)) {
        ...
        (_this$_headerScrollab = this._headerScrollable) === null || _this$_headerScrollab === void 0 ? void 0 : _this$_headerScrollab.scrollTo({
  ...
  _updateScrollable() {
    ...
    (_this$_headerScrollab2 = this._headerScrollable) === null || _this$_headerScrollab2 === void 0 ? void 0 : _this$_headerScrollab2.update();
    (_this$_sidebarScrolla2 = this._sidebarScrollable) === null || _this$_sidebarScrolla2 === void 0 ? void 0 : _this$_sidebarScrolla2.update();
  }
  ...
  _createDragBehaviorBase($element, options) {
    ...
    this.dragBehavior.addTo($element, createDragBehaviorConfig(container, isDefaultDraggingMode, this.dragBehavior, attachGeneralEvents, detachGeneralEvents, () => this._getDroppableCell(), () => this._getDateTables(), () => this.removeDroppableCellClass(), () => this.getCellWidth(), options));
  } // --------------
