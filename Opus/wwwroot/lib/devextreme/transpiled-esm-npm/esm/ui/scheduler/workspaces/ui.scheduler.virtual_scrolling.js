...
export class VirtualScrollingDispatcher {
  ...
  get viewportHeight() {
    return this.height ? this.options.getViewHeight() : getWindow().innerHeight; // TODO: refactor, we can't use it here
  }
  ...
  get viewportWidth() {
    return this.width ? this.options.getViewWidth() : getWindow().innerWidth; // TODO: refactor, we can't use it here
  }
