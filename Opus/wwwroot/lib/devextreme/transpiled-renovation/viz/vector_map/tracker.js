...
exports.Focus = Focus = function Focus(fire) {
  var that = this;
...
(0, _event_emitter.makeEventEmitter)(Tracker); ///#DEBUG
...
function setupEvents() {
  var flags = [navigator.pointerEnabled, navigator.msPointerEnabled, (0, _window.hasProperty)('ontouchstart')]; ///#DEBUG
