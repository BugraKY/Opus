...
var _TESTS_MapLayer = MapLayer;
exports._TESTS_MapLayer = _TESTS_MapLayer;

var _TESTS_stub_MapLayer = function _TESTS_stub_MapLayer(stub) {
  MapLayer = stub;
};

exports._TESTS_stub_MapLayer = _TESTS_stub_MapLayer;
var _TESTS_selectStrategy = selectStrategy;
exports._TESTS_selectStrategy = _TESTS_selectStrategy;

var _TESTS_stub_selectStrategy = function _TESTS_stub_selectStrategy(stub) {
  selectStrategy = stub;
};

exports._TESTS_stub_selectStrategy = _TESTS_stub_selectStrategy;
var _TESTS_MapLayerElement = MapLayerElement;
exports._TESTS_MapLayerElement = _TESTS_MapLayerElement;

var _TESTS_stub_MapLayerElement = function _TESTS_stub_MapLayerElement(stub) {
  MapLayerElement = stub;
};

exports._TESTS_stub_MapLayerElement = _TESTS_stub_MapLayerElement;
var _TESTS_createProxy = createProxy;
exports._TESTS_createProxy = _TESTS_createProxy;

var _TESTS_stub_performGrouping = function _TESTS_stub_performGrouping(stub) {
  performGrouping = stub;
};

exports._TESTS_stub_performGrouping = _TESTS_stub_performGrouping;
var _TESTS_performGrouping = performGrouping;
exports._TESTS_performGrouping = _TESTS_performGrouping;

var _TESTS_stub_groupByColor = function _TESTS_stub_groupByColor(stub) {
  groupByColor = stub;
};

exports._TESTS_stub_groupByColor = _TESTS_stub_groupByColor;
var _TESTS_groupByColor = groupByColor;
exports._TESTS_groupByColor = _TESTS_groupByColor;

var _TESTS_stub_groupBySize = function _TESTS_stub_groupBySize(stub) {
  groupBySize = stub;
};

exports._TESTS_stub_groupBySize = _TESTS_stub_groupBySize;
var _TESTS_groupBySize = groupBySize;
exports._TESTS_groupBySize = _TESTS_groupBySize;
var _TESTS_findGroupingIndex = findGroupingIndex; ///#ENDDEBUG

exports._TESTS_findGroupingIndex = _TESTS_findGroupingIndex;