...
exports.plugin = exports._setLegend = exports._DEBUG_stubMarkerCreator = exports._DEBUG_restoreMarkerCreator = exports.Legend = void 0;
...
function parseOptions(options, textField, allowInsidePosition) {
  if (!options) return null; ///#DEBUG

  _console.debug.assertParam(options.visible, 'Visibility was not passed');

  _console.debug.assertParam(options.markerSize, 'markerSize was not passed');

  _console.debug.assertParam(options.font.color, 'fontColor was not passed');

  _console.debug.assertParam(options.font.family, 'fontFamily was not passed');

  _console.debug.assertParam(options.font.size, 'fontSize was not passed');

  _console.debug.assertParam(options.paddingLeftRight, 'paddingLeftRight was not passed');

  _console.debug.assertParam(options.paddingTopBottom, 'paddingTopBottom was not passed');

  _console.debug.assertParam(options.columnItemSpacing, 'columnItemSpacing was not passed');

  _console.debug.assertParam(options.rowItemSpacing, 'rowItemSpacing was not passed'); ///#ENDDEBUG
...
var _setLegend = function _setLegend(value) {
  exports.Legend = Legend = value;
};

exports._setLegend = _setLegend;
var __getMarkerCreator = getMarkerCreator;

var _DEBUG_stubMarkerCreator = function _DEBUG_stubMarkerCreator(callback) {
  getMarkerCreator = function getMarkerCreator() {
    return callback;
  };
};

exports._DEBUG_stubMarkerCreator = _DEBUG_stubMarkerCreator;

var _DEBUG_restoreMarkerCreator = function _DEBUG_restoreMarkerCreator() {
  getMarkerCreator = __getMarkerCreator;
}; ///#ENDDEBUG


exports._DEBUG_restoreMarkerCreator = _DEBUG_restoreMarkerCreator;