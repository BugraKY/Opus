...
var Tracker = _class.default.inherit({
  ctor: function ctor(parameters) {
    ...
    _console.debug.assertParam(parameters.container, 'parameters.container'); ///#ENDDEBUG
    ...
    that.TOOLTIP_HIDE_DELAY = TOOLTIP_HIDE_DELAY; ///#ENDDEBUG
  },
  ...
  _showTooltip: function _showTooltip(event) {
    ...
    that._hideTooltipTimeout && ++that._DEBUG_hideTooltipTimeoutCleared; ///#ENDDEBUG
  ...
  _hideTooltip: function _hideTooltip(delay) {
    ...
    if (delay) {
      ///#DEBUG
      ++that._DEBUG_hideTooltipTimeoutSet; ///#ENDDEBUG
...
var active_touch_tooltip_tracker = null; ///#DEBUG
