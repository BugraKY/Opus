...
TextEditorBase.mockTextEditorLabel = function (mock) {
  TextEditorLabelCreator = mock;
};

TextEditorBase.restoreTextEditorLabel = function (mock) {
  TextEditorLabelCreator = _uiText_editor2.TextEditorLabel;
}; ///#ENDDEBUG
